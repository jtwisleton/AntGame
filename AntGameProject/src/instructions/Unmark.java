...
/**
 * Provides implementation for the Unmark instruction, which removes a given
 * mark from the ants position.
 *
 * @author Team18
 *
 */
public class Unmark implements Instruction {
     ...
     * @param nextState the next state so set for the ant once the mark is
     * cleared.
     */
