...
public class Flip implements Instruction {
     ...
     * @param nextStateIfZero is the next state that is set if the random number if 0.
     * @param nextStateElse is the next state that is set if the random number is greater than 0.
     */
     ...
     * @param randomNumberGen random number generator used to choose outcome of flip.
     */
    @Override
