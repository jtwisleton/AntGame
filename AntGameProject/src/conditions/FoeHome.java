...
public class FoeHome  implements Condition {
    ...
    /**
     * Sense if an ant hill of different colour to that of the ant given is in the 
     * sense position on the given board.
     ...
     * @return true in an ant hill is in the given position that is not the colour of the
     * given ant and false otherwise.
     */
    @Override
