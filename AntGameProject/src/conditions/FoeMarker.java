...
public class FoeMarker  implements Condition {
    ...
    /**
     * Sense if there is any marker of a colour different to the ant specified in 
     * the given position.
     ...
     * @return true is any markers on the tile of colour that is not the given ant colour 
     * and false otherwise.
     */
    @Override
