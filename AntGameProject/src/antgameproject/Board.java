...
public class Board {
    ...
    */
     ...
     * @param colourOfTeam the colour of the team to find the number alive ants of.
     ...
     * @param colourOfTeam colour of the team to get the amount of food in the base.
     ...
     * @return true if the given marker for the given colour is found in the given position
     * and false otherwise.
     */
    ...
    /**
     * Prints the board to ASCII representation. Used for testing and bug finding.
     */
