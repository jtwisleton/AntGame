...
public class Ant {
    ...
    /**
     * Returns if the ant is currently carrying food. An ant can carry at a maximum one 
     * bit of food.
     ...
     * @param carryingFood true if the ant is carrying food and false if it is not.
     */
    ...
    /**
     * Returns the period of resting that the ant has. Currently used for testing only.
